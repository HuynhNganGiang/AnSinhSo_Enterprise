...
/// <summary>
/// Handler xử lý lệnh kích hoạt chính sách.
/// </summary>
public sealed class ActivatePolicyCommandHandler : IRequestHandler<ActivatePolicyCommand, Result>
{
    private readonly IPolicyRepository _policyRepository;
    private readonly IUnitOfWork _unitOfWork;

    /// <summary>
    /// Khởi tạo ActivatePolicyCommandHandler.
    /// </summary>
    public ActivatePolicyCommandHandler(IPolicyRepository policyRepository, IUnitOfWork unitOfWork)
    {
