...
public class UserRoleRevokedDomainEventHandler : INotificationHandler<DomainEventNotification<UserRoleRevokedDomainEvent>>
{
    private readonly IAuthorizationCacheService _cacheService;

    public UserRoleRevokedDomainEventHandler(IAuthorizationCacheService cacheService)
    {
        _cacheService = cacheService;
    }

    public async Task Handle(DomainEventNotification<UserRoleRevokedDomainEvent> notification, CancellationToken cancellationToken)
    {
