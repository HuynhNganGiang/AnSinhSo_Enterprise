...
/// <summary>
/// Handler xử lý lệnh hủy kích hoạt nhóm phúc lợi.
/// </summary>
public sealed class DeactivateWelfareGroupCommandHandler : IRequestHandler<DeactivateWelfareGroupCommand, Result>
{
    private readonly IWelfareGroupRepository _welfareGroupRepository;
    private readonly IUnitOfWork _unitOfWork;

    /// <summary>
    /// Khởi tạo DeactivateWelfareGroupCommandHandler.
    /// </summary>
    public DeactivateWelfareGroupCommandHandler(
    ...
    /// <summary>
    /// Xử lý lệnh hủy kích hoạt nhóm phúc lợi.
    /// </summary>
    public async Task<Result> Handle(DeactivateWelfareGroupCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = welfareGroup.Deactivate();
